...
#  If you want to create a derived class that represents a circle, you can override the area method and provide
#  an implementation that calculates the area of a circle:
...
# and overrides the area method. The new implementation of the area method calculates the area of a circle, based on its radius.
...
#  To do this, you can use the super function. The super function allows you to call the base class method
#  from the derived class method, and can be useful when you want to extend the behavior of the base class method, rather than replace it.
...
#  If you want to create a derived class that represents a circle, and you also want to print a message indicating
#  the type of shape, you can use the super function to call the base class method, and add your own message:
...
#  super function. This allows you to extend the behavior of the base class method, while still maintaining its original behavior.
...
# Additionally, by using the super function, you can extend the behavior of a base class method, 
# rather than replace it, giving you even greater flexibility and control over the behavior of your classes.